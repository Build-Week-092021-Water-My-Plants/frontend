...
- [SPA & React Router](#spa--react-router)
  ...
  - [Using cookies to transfer session data.](#using-cookies-to-transfer-session-data)
    - [Advantages when using cookies:](#advantages-when-using-cookies)
    - [Drawbacks when using cookies:](#drawbacks-when-using-cookies)
